...
public class NodeCachingLinkedListTest_remove_0 {
    ...
    @Test
    public void testremove_0(String fileClasspath, String className, String methodName) throws IllegalAccessException, InvocationTargetException, ClassNotFoundException, InstantiationException, MalformedURLException {
           ...
           cl2 = null;
        issta.nodecachinglinkedlist.LinkedListNode _LinkedListNode_1 = new issta.nodecachinglinkedlist.LinkedListNode();
        issta.nodecachinglinkedlist.LinkedListNode _LinkedListNode_2 = new issta.nodecachinglinkedlist.LinkedListNode();
        issta.nodecachinglinkedlist.LinkedListNode _LinkedListNode_3 = new issta.nodecachinglinkedlist.LinkedListNode();
        issta.nodecachinglinkedlist.LinkedListNode _LinkedListNode_4 = new issta.nodecachinglinkedlist.LinkedListNode();
        int index = 0;
        ...
        updateValue(instance, "size", 1);
        updateValue(instance, "DEFAULT_MAXIMUM_CACHE_SIZE", 3);
        updateValue(instance, "modCount", -1);
