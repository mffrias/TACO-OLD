...
public class AvlTreeTest_fibo_0 {
    ...
    @Test
    public void testfibo_0() {
        ar.edu.itba.materia.avl.AvlTree instance = null;
        int n = 2;
        // Parameter Initialization
        
        // Method Invocation
        Method method = getAccessibleMethod("ar.edu.itba.materia.avl.AvlTree", "fibo", true);
        try {
            method.invoke(instance, new Object[]{n});
        } catch (Exception e) {
            e.printStackTrace();
        } 
