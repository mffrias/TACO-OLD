...
public class LandingTest_testInfinity_0 {
    ...
    @Test
    public void testtestInfinity_0() {
        ar.edu.taco.skunk.Landing instance = new ar.edu.taco.skunk.Landing();
        float fl_Float_1 = -1.7014118E38f;
        // Parameter Initialization
        
        // Method Invocation
        Method method = getAccessibleMethod("ar.edu.taco.skunk.Landing", "testInfinity", true);
        try {
            method.invoke(instance, new Object[]{fl_Float_1});
        } catch (Exception e) {
            e.printStackTrace();
        } 
