...
public class LandingTest_aerodynamic1_0 {
    ...
    @Test
    public void testaerodynamic1_0() {
        ar.edu.taco.skunk.Landing instance = new ar.edu.taco.skunk.Landing();
        int i1_Integer_1 = -1936783991;
        int i2_Integer_2 = -246174513;
        int i3_Integer_3 = 932549551;
        int i4_Integer_4 = -2084010553;
        int i5_Integer_5 = 175850495;
        // Parameter Initialization
        
        // Method Invocation
        Method method = getAccessibleMethod("ar.edu.taco.skunk.Landing", "aerodynamic1", true);
        try {
            method.invoke(instance, new Object[]{i1_Integer_1, i2_Integer_2, i3_Integer_3, i4_Integer_4, i5_Integer_5});
        } catch (Exception e) {
            e.printStackTrace();
        } 
