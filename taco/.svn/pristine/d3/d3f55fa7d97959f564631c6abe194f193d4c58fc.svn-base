...
public class LandingTest_initLandingOK_0 {
    ...
    @Test
    public void testinitLandingOK_0() {
        ar.edu.taco.skunk.Landing instance = new ar.edu.taco.skunk.Landing();
        float height_Float_1 = Float.NaN;
        // Parameter Initialization
        
        // Method Invocation
        Method method = getAccessibleMethod("ar.edu.taco.skunk.Landing", "initLandingOK", true);
        try {
            method.invoke(instance, new Object[]{height_Float_1});
        } catch (Exception e) {
            e.printStackTrace();
        } 
