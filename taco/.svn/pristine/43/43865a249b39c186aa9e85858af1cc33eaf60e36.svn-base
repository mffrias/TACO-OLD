...
public class SinglyLinkedListTest_contains_0 {
    ...
    public void testcontains_0(String fileClasspath, String className, String methodName) throws IllegalAccessException, InvocationTargetException, ClassNotFoundException, InstantiationException, MalformedURLException {
        ...
        updateValue(_SinglyLinkedListNode_5, "value", _SinglyLinkedListNode_5);
        updateValue(_SinglyLinkedListNode_4, "next", _SinglyLinkedListNode_5);
        updateValue(_SinglyLinkedListNode_4, "value", _SinglyLinkedListNode_5);
        updateValue(_SinglyLinkedListNode_3, "next", _SinglyLinkedListNode_4);
        updateValue(_SinglyLinkedListNode_3, "value", _SinglyLinkedListNode_5);
        ...
        updateValue(_SinglyLinkedListNode_1, "value", _SinglyLinkedListNode_5);
