...
public class LandingTest_testDiv_0 {
    ...
    @Test
    public void testtestDiv_0() {
        ar.edu.taco.skunk.Landing instance = new ar.edu.taco.skunk.Landing();
        int i1_Integer_1 = 0;
        int i2_Integer_2 = -2147483648;
        int i3_Integer_3 = -2147483648;
        // Parameter Initialization
        
        // Method Invocation
        Method method = getAccessibleMethod("ar.edu.taco.skunk.Landing", "testDiv", true);
        try {
            method.invoke(instance, new Object[]{i1_Integer_1, i2_Integer_2, i3_Integer_3});
        } catch (Exception e) {
            e.printStackTrace();
        } 
