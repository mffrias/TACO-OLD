...
//		//mfrias 02-13-2014 ArithmeticException extension
//		
//		if (TacoConfigurator.getInstance().getBoolean(TacoConfigurator.CHECK_ARITHMETIC_EXCEPTION) == true) {
//			List<JStatement> ArithmeticExceptionHeader = ArithmeticExceptionSolver.buildArithmeticExceptionHeader();
//
//			JStatement arithmeticExceptionBody = ArithmeticExceptionSolver.buildArithmeticExceptionBody(program);
//			JStatement arithmeticExceptionTail = ArithmeticExceptionSolver.buildArithmeticExceptionTail();
//
//			List<JStatement> stmtList = new LinkedList<JStatement>();
//			stmtList.addAll(ArithmeticExceptionHeader);
//			stmtList.add(arithmeticExceptionBody);
//			stmtList.add(arithmeticExceptionTail);
//
//			program = new JBlock(stmtList);
//
//		}
