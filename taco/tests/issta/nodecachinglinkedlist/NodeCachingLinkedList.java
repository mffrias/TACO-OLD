 ...
 *//*@ nullable_by_default @*/public class NodeCachingLinkedList {
    ...
    public issta.nodecachinglinkedlist.LinkedListNode header;

    public issta.nodecachinglinkedlist.LinkedListNode firstCachedNode;
    ...
    public NodeCachingLinkedList() {
        this.header = new issta.nodecachinglinkedlist.LinkedListNode();
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
    	...
    	if (this.cacheSize < this.maximumCacheSize) {
    		issta.nodecachinglinkedlist.LinkedListNode nextCachedNode;
