...
public class SinglyLinkedListTest extends CollectionTestBase {
	...
	protected String getClassToCheck() {
		return "SourcesCristianPereyra.SinglyLinkedList";
	}

	public void test_addTest() throws VizException {
		setConfigKeyRelevantClasses("SourcesCristianPereyra.SinglyLinkedList,SourcesCristianPereyra.Node");
        ...
        this.setConfigKeyRemoveQuantifiers(true);
...
//		this.setConfigKeyObjectScope(6);
		...
		setConfigKeyInferScope(true);
		setConfigKeyTypeScopes("SourcesCristianPereyra.SinglyLinkedList:1, SourcesCristianPereyra.Node:4, int:4");
