...
public class DynAlloyCompiler {
	...
	public void compile(String inputFilename, String outputFilename, DynAlloyOptions options,
			...
			HashMap<String, List<AlloyFormula>> predsComingFromArithmeticConstraintsInObjectInvariantsByModule) throws RecognitionException, TokenStreamException, IOException,
			AssertionNotFound {
